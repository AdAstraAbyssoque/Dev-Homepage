...
<template>
  ...
  <div v-if="frontmatter.layout !== false"
       class="trm-app-frame">
    <div id="trm-dynamic-content"
         class="trm-swup-animation">
        ...
        <div class="container">
          <div class="row">
            ...
            <TrmPageContent>
              ...
              <TrmPageArchive v-else-if="['tags', 'archives', 'categories'].includes(frontmatter.layout)"
                              :type="frontmatter.layout"
                              :key="frontmatter.layout" />
